...
// create board
const createBoardModel = async (boardName) => {
  console.log("createBoardModel : ", boardName);
  const createQuery =
...
// update board
const updateBoardModel = async (boardName, id) => {
  console.log("createBoardModel : ", boardName, id);
  const updateQuery =
    "UPDATE trelloschema.boards SET board_name = $1 WHERE board_id = $2 RETURNING *";
  const values = [boardName, id];
